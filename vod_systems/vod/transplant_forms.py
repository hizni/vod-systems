...
class TransplantCreateUpdateForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super(TransplantCreateUpdateForm, self).__init__(*args, **kwargs)

        self.helper = FormHelper()

        self.helper.form_id = 'form'
        self.helper.form_action = reverse('transplant-create')
...
class TransplantRetireForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super(TransplantRetireForm, self).__init__(*args, **kwargs)
